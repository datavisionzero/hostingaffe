    ...
    public async Task The_tables_are_the_ones_storage_md_declares()
    {
        ...
        Assert.Equal(
            [
                ...
                "installation", "installation_port", "machine", "one_time_secret", "page",
                "software", "token",
            ],
            tables);
    }
    ...
    public async Task The_indexes_are_the_ones_storage_md_declares()
    {
        ...
        Assert.Equal(
            [
                ...
                "pk_machine", "pk_one_time_secret", "pk_page",
                "pk_software", "pk_token", "software_key", "token_agent", "token_secret_hash",
            ],
            indexes);
